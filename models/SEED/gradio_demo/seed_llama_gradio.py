...
def http_bot(dialog_state, input_state, temperature, top_p, max_new_tokens, num_beams, max_turns, force_image_gen, request: gr.Request):
    ...
    response = requests.request(method="POST", url=args.request_address, headers=headers, json=payload, timeout=50000)
...
if __name__ == '__main__':
    ...
    examples_mix = [
        [None, 'Can you use images and texts to tell me how to draw a dog? '],
